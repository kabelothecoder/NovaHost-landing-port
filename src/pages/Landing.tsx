 ...
 *
 * Defaults to the signed release build in the `downloads` bucket on the NovaHost
 * backend. `VITE_APK_URL` overrides it (set in the Vercel project) so the file
 * can be moved without a code change. An unset *or empty* override falls through
 * to the default — a blank env var must not silently disable the button.
 */
